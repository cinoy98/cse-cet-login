...
function getChallenge() {
    return rest_get(
        ...
        if (response.error) {
            console.log("Error in get challenge: ", response.error);
...
function createCredential(challenge) {
    ...
    return navigator.credentials.create({
        ...
        if (response.error) {
            console.log("Error in create credential ", response.error);
...
function getAssertion(challenge) {
    ...
    return navigator.credentials.get({
        ...
        if (response.error) {
            console.log("ERror in get credential :", response.error)
            return Promise.reject(response.error);
        } else {
            return Promise.resolve(response.result);
        }
